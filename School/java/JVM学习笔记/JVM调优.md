...
> ### 转载: [JVM调优总结（一）-- 一些概念](http://pengjiaheng.iteye.com/blog/518623)
>
> ### 转载: [JVM调优总结（二）-- 一些概念](http://pengjiaheng.iteye.com/blog/519471)
>
> ### 转载: [JVM调优总结（三）-- 基本垃圾回收算法](http://pengjiaheng.iteye.com/blog/520228)
>
> ### 转载: [JVM调优总结（四）-- 垃圾回收面临的问题](http://pengjiaheng.iteye.com/blog/523230)
>
> ### 转载: [JVM调优总结（五）-- 分代垃圾回收详述1](http://pengjiaheng.iteye.com/blog/524024)
>
> ### 转载: [JVM调优总结（六）-- 分代垃圾回收详述2](http://pengjiaheng.iteye.com/blog/528034)
>
> ### 转载: [JVM调优总结（七）-- 典型配置举例1](http://pengjiaheng.iteye.com/blog/538582)
>
> ### 转载: [JVM调优总结（八）-- 典型配置举例2](http://pengjiaheng.iteye.com/blog/545015)
>
> ### 转载: [JVM调优总结（九）-- 新一代的垃圾回收算法](http://pengjiaheng.iteye.com/blog/548472)
>
> ### 转载: [JVM调优总结（十）-- 调优方法](http://pengjiaheng.iteye.com/blog/552456)
>
> ### 转载: [JVM调优总结（十一）-- 反思](http://pengjiaheng.iteye.com/blog/558619)
...
![JVM Tuning 001](https://images.cnblogs.com/cnblogs_com/andy-zhou/806435/o_Jvm_Tuning001.gif)
...
![JVM Tuning 006](https://images.cnblogs.com/cnblogs_com/andy-zhou/806435/o_Jvm_Tuning006.png)
