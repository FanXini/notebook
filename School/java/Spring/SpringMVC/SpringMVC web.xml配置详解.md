# [Spring MVC的web.xml配置详解(转)](https://www.cnblogs.com/wkrbky/p/5929943.html)

出处http://blog.csdn.net/u010796790

1、[spring](http://lib.csdn.net/base/javaee) 框架解决字符串编码问题：过滤器 **CharacterEncodingFilter**（filter-name） 
